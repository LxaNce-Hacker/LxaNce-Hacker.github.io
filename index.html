...
<title>LxaNce</title>
<!-- add icon link -->
<link rel = "icon" href = "https://i.postimg.cc/50NBfqwK/skull.png" type = "image/x-icon">
<meta charset="UTF-8">
...
<nav class="w3-sidebar w3-bar-block w3-small w3-hide-small w3-center">
  ...
  <img src="https://i.ibb.co/6rtfDRJ/2020-03-30.jpg" style="width:100%">
...
<a href="https://lxance-hacker.github.io/"><img height="25" title="Counter" src="https://komarev.com/ghpvc/?username=LxaNce-Hacker&color=blueviolet&style=flat-square"></a>
...
<a href="https://www.2braces.com/c-questions/">All C Programming!<br>
<a href="https://www.tutorialspoint.com/questions/category/operating-system">All Things About Language Related!<br>
<a href="https://www.indiabix.com/computer-science/computer-fundamentals/049006">Computer Fundamental!<br>
<a href="https://dare2compete.com/">Dare2Complete!<br>
<a href="https://smartserials.com/">Free Product Keys!<br>
<a href="https://imagecompressor.11zon.com/en/image-compressor/compress-jpeg-to-30kb.php">File Compressor(.jpg etc)!<br>
...
<a href="https://online-decoder.com/he/ei">Guess Decoder!<br>
...
<a href="https://www.browserling.com/tools/utf8-encode">UTF8-Encoder/Decoder!<br>
<a href="https://webhook.site/">WebHookSite For Data Gethering!</a>
  <!-- About Section -->
  <div class="w3-content w3-justify w3-text-grey w3-padding-64" id="about">
    <h2 class="w3-text-light-grey">My Name</h2>
    <hr style="width:200px" class="w3-opacity">
    <p>About me : I'm Prince And I'm a CSE Student.
    </p>
    <h3 class="w3-padding-16 w3-text-light-grey">My Skills</h3>
    <p class="w3-wide">Hacking</p>
    <div class="w3-white">
    ...
    <div class="w3-row w3-center w3-padding-16 w3-section w3-light-grey">
      <div class="w3-quarter w3-section">
        <span class="w3-xlarge">No</span><br>
        Partners
      </div>
      <div class="w3-quarter w3-section">
    ...
    <div class="w3-row-padding" style="margin:0 -16px">
      <div class="w3-half w3-margin-bottom">
        <ul class="w3-ul w3-white w3-center w3-opacity w3-hover-opacity-off">
          ...
          <li class="w3-padding-16">Hacking</li>
    ...
    <p><span class="w3-large w3-margin-right">Yash.</span> Student Of PSIT.</p>
    <p>No one is better than Prince.</p>
  <!-- End About Section -->
  </div>
  ...
  <div class="w3-padding-64 w3-content w3-text-grey" id="contact">
    ...
    <div class="w3-section">
      <p><i class="fa fa-map-marker fa-fw w3-text-white w3-xxlarge w3-margin-right"></i> Utter Pradesh, India</p>
      <p><i class="fa fa-phone fa-fw w3-text-white w3-xxlarge w3-margin-right"></i> Phone: +917992145768</p>
      <p><i class="fa fa-envelope fa-fw w3-text-white w3-xxlarge w3-margin-right"> </i> Email: princekatiyar4404@gmail.com</p>
    </div><br>
  ...
  <footer class="w3-content w3-padding-64 w3-text-grey w3-xlarge">
    <a href="https://www.facebook.com/prince.katiyar.4404"><i class="fa fa-facebook-official w3-hover-opacity"></i></a>
    <a href="https://www.instagram.com/lxance.exe"><i class="fa fa-instagram w3-hover-opacity"></i></a>
    <a href="/"><i class="fa fa-snapchat w3-hover-opacity"></i></a>
    <a href="https://pin.it/57eTU6l"><i class="fa fa-pinterest-p w3-hover-opacity"></i></a>
    <a href="https://twitter.com/PrinceK82685480"><i class="fa fa-twitter w3-hover-opacity"></i></a>
    <a href="https://www.linkedin.com/in/prince-katiyar-53b830226"><i class="fa fa-linkedin w3-hover-opacity"></i></a>
    <p class="w3-medium">Powered by <a href="/" target="_blank" class="w3-hover-text-green">LxaNce</a></p>
  <!-- End footer -->
  </footer>
